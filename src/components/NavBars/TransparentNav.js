...
const NavLink = ({ to, label, textClassName }) => (<>
    <a href={to} className="font-medium text-gray-400 hover:text-gray-400 sm:py-6">{label}</a>
</>)
...
const NavBar = () => {
    ...
    return (
        <>
            <header className="absolute flex flex-wrap sm:justify-start sm:flex-nowrap z-50 w-full bg-transparent text-sm py-3 sm:py-0 ">
                <nav className="relative max-w-7xl w-full mx-auto px-4 sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8" aria-label="Global">
                    <div className="flex items-center justify-between">
                        <a className="flex-none text-xl font-semibold" href="/" aria-label="Brand">👨</a>
                    ...
                    <div id="navbar-collapse-with-animation" className="hs-collapse hidden overflow-hidden transition-all duration-300 basis-full grow sm:block">
                        <div className="flex flex-col gap-y-4 gap-x-0 mt-5 sm:flex-row sm:items-center sm:gap-y-0 sm:gap-x-7 sm:mt-0 sm:pl-7">
                            ...
                            <a href="https://docs.google.com/document/d/1jCVBOuMSMXk_H_InM8oOSMxjEbsedw-O6ZwQo8Tcxq4/edit?usp=share_link" target="blank" className="font-medium text-gray-400 hover:text-gray-400 sm:py-6">Resume</a>
