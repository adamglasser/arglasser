  ...
  return (<>
    <header className="navbar navbar-expand-lg navbar-dark bd-navbar sticky-top main-header-nav">
      <nav className="container-fluid bd-gutter flex-wrap flex-lg-nowrap " aria-label="Main navigation ">
        ...
        <button onClick={() => onToggle()} className="navbar-toggler border border-dark border-2 d-flex d-lg-none order-3 p-2" type="button" data-bs-toggle="offcanvas" data-bs-target="#bdNavbar" aria-controls="bdNavbar" aria-expanded="false" aria-label="Toggle navigation">
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="dark" className="bi bi-three-dots" viewBox="0 0 16 16">
        ...
        <div className="offcanvas-lg offcanvas-end flex-grow-1 main-header-nav-expand" ref={navBody} id="bdNavbar" aria-labelledby="bdNavbarOffcanvasLabel" data-bs-scroll="true" >
          ...
          <div className="offcanvas-body p-4 pt-0 p-lg-0">
            ...
            <ul className="navbar-nav flex-row flex-wrap ms-md-auto">
              <li className="nav-item col-6 col-lg-auto py-2">
                <a className=" py-2 px-0 px-lg-2 icon custom-nav-link" href="https://instagram.com/arglasser" target="_blank" rel="noopener">
              ...
              <li className="nav-item col-6 col-lg-auto py-2">
                <a className=" py-2 px-0 px-lg-2 icon custom-nav-link" href="https://www.linkedin.com/in/adam-glasser-109148142/" target="_blank" rel="noopener">
              ...
              <li className="nav-item col-6 col-lg-auto py-2">
                <a className=" py-2 px-0 px-lg-2 icon custom-nav-link" href="https://codepen.io/adamglasser" target="_blank" rel="noopener">
