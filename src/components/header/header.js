      ...
      <nav className="container-fluid bd-gutter flex-wrap flex-lg-nowrap " aria-label="Main navigation ">
        ...
        <div className="offcanvas-lg offcanvas-end flex-grow-1 main-header-nav-expand" ref={navBody} id="bdNavbar" aria-labelledby="bdNavbarOffcanvasLabel" data-bs-scroll="true" >
          ...
          <div className="offcanvas-body p-4 pt-0 p-lg-0">
            ...
            <NavLink to="/" label="Home" className="nav-link px-2" />
            ...
            <ul className="navbar-nav flex-row flex-wrap ms-md-auto">
              <li className="nav-item col-6 col-lg-auto">
                <a className="nav-link py-2 px-0 px-lg-2 icon" href="https://instagram.com/arglasser" target="_blank" rel="noopener">
              ...
              <li className="nav-item col-6 col-lg-auto">
                <a className="nav-link py-2 px-0 px-lg-2 icon" href="https://www.linkedin.com/in/adam-glasser-109148142/" target="_blank" rel="noopener">
              ...
              <li className="nav-item col-6 col-lg-auto">
                <a className="nav-link py-2 px-0 px-lg-2 icon" href="https://codepen.io/adamglasser" target="_blank" rel="noopener">
